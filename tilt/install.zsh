...
# Check if Tilt is already installed via Homebrew
if brew ls --versions tilt >/dev/null 2>&1; then
    log_info "Tilt is already installed."
    exit 0
fi

# Install Tilt using Homebrew
log_info "Installing Tilt using Homebrew..."
brew install tilt

log_info "Tilt installation completed successfully."
exit 0
